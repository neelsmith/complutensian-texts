...
md"""*Include*: $(@bind scope Select(["Septuagint", "Genesis", "edited chapters"]; default = "edited chapters")) *Sort list*: $(@bind ordering Select(["alphabetically", "by frequency"]; default = "by frequency"))"""

# ╔═╡ b1fe9842-2c4e-4c41-a171-34206d90e2e5
html"""
<br/><br/><br/><br/><br/>
"""

# ╔═╡ 79dc987c-2612-42de-9be8-d8815059f485
md"""> # Mechanics"""

# ╔═╡ 63c5d6d8-69ff-42e3-808e-baf7a3264804
md"""> ## Corpus"""

# ╔═╡ 83fc06b3-1007-4000-9bb1-3e66d1f6f45a
chaptlist = collect(1:37) .|> string

# ╔═╡ 58a17245-30f9-4778-a5b9-afd3ea916d36
"""Instantiate edition of Septuagint."""
function sept()
	   url = "https://github.com/neelsmith/compnov/raw/main/corpus/compnov.cex"
	   c = fromcex(url, CitableTextCorpus, UrlReader)
	   filter(p -> versionid(p.urn) == "septuagint", c.passages) |> CitableTextCorpus
end
...
genesis = filter(lxx.passages) do psg
...
tokens = tokenize(selected_corpus, literaryGreek())
...
stringtokens = map(t -> knormal(tokentext(t)), lex)
...
> How may unique tokens? How many lexemes?

Failed: $(length(fails))  (unique tokens: $(length(failed_freq)))
"""

# ╔═╡ 4b19d091-8b4d-40f8-a4a0-6c350c4e8e07
failed_alpha = failed_freq |> sort

# ╔═╡ 4da20ed9-cdbc-4708-af6b-c4e2ef56aaff
md"""> ## Coverage by chapter"""

# ╔═╡ b7a33995-8d2e-46ca-bc9b-b8c8d6f35b7e
...
# ╔═╡ c7c13ca5-70b7-453d-aa47-7350055164a1
lxxcoverage = map(c -> coverage(c), chaptlist)

# ╔═╡ 3bf76de8-058c-416a-8108-9f47ed4c360f
#groupedbar([lxxcoverage lxxcoverage], bar_position = :dodge, bar_width=0.7, xticks=(1:37, chaptlist))
bar(chaptlist, lxxcoverage, label="Percent parsed by chapter", xlabel = "Chapter", ylabel = "Percent parsed", xticks=(0:36, chaptlist))

# ╔═╡ b500bd5f-c977-4d5a-ba38-4baca146fe79
md"""> ## UI"""

# ╔═╡ b96397be-3c4b-4ede-b9f7-ae7c7793d265
function menulabel(s; dict = sorted)
	dict[s] == 1 ? string(s, " (", dict[s], " occurrence)") : string(s, " (", dict[s], " occurrences)")
end

# ╔═╡ 6471ec43-80f6-403a-bb26-44080e128b47
...
# ╔═╡ b212e992-18a3-421d-b2ab-fbb0c245bf16
...
manifest_format = "2.0"
project_hash = "01d85ac063c269b30cd9c89a934cde40a5e869b4"
