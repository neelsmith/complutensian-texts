...
begin
	if isnothing(surfaceurn)
		...
		Markdown.parse(indexingcompleteness_html(r, surfaceurn, strict = false, height=thumbht))
	end
end
...
if isnothing(surfaceurn)
	...
	mdsrc = indexingaccuracy_html(r, surfaceurn, strict = false, height=textheight)
...
manifest_format = "2.0"
project_hash = "5a3df359c472ce0123829a8ffcc3ef4d57bd3791"
