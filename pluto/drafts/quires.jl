...
begin
	...
	using Kroki
	using PlutoUI
	md"""*Unhide this cell to see the Pluto environment.*"""
end

# ╔═╡ f84b05c3-aaa0-469a-97ef-3030c10c3757
baseurl = "http://www.homermultitext.org/iipsrv"



# ╔═╡ b91217b9-de51-4b45-a7bd-768f2210ca27
root = "/project/homer/pyramidal/deepzoom"


# ╔═╡ 6d9ef9ce-8ef8-4c15-ad7d-13ae890db891
service = IIIFservice(baseurl, root)

# ╔═╡ e9e436c8-0596-46e2-8bd2-2b1aa1ab4100
ict = "http://www.homermultitext.org/ict2/?"

# ╔═╡ 2bd51a5d-c1d9-49c0-bad8-8d154d277544
mermaid"""
flowchart TD
     A[<img src='https://www.homermultitext.org/iipsrv?OBJ=IIP,1.0&FIF=/project/homer/pyramidal/deepzoom/citebne/complutensian/v1/v1p19.tif&wID=100
&CVT=JPEG'/>]
     A --> B[Regular Node]
"""

# ╔═╡ b2bc96a6-a7a9-43cc-bc50-e68e622108f7
mermaid"""
flowchart TD
     A[<a href='http://www.homermultitext.org/ict2/?urn=urn:cite2:citebne:complutensian.v1:v1p19'><img class='citeImage' alt='image' src='http://www.homermultitext.org/iipsrv?IIIF=/project/homer/pyramidal/deepzoom/citebne/complutensian/v1/v1p19.tif/full/100,/0/default.jpg'/></a>]
	 A --> B[Text node]
"""	 



# ╔═╡ d933155e-0bc2-484e-ada1-607f4602115f


# ╔═╡ 2081cfc8-9b35-4ee7-bc22-165f6efa33e7
dummyu = "https://www.homermultitext.org/iipsrv?OBJ=IIP,1.0&FIF=/project/homer/pyramidal/deepzoom/citebne/complutensian/v1/v1p19.tif&wID=100
&CVT=JPEG"

# ╔═╡ 3aa65c0b-832d-49a9-a2ce-40249b68fb60
mermaid"""
flowchart TD
     A[<img src='https://www.homermultitext.org/iipsrv?OBJ=IIP,1.0&FIF=/project/homer/pyramidal/deepzoom/citebne/complutensian/v1/v1p19.tif&wID=100&CVT=JPEG'/>]
     A --> B[Regular Node]
"""
...
# ╔═╡ f5d267fe-49cd-4cf9-884b-bf864cc82be4
dummyurn = data[1].image |> Cite2Urn

# ╔═╡ ba9900a6-96fc-41d3-9aed-2a8bcd3bc93c
h = linkedHtmlImage(ict, dummyurn, service; w = 100) 


# ╔═╡ d62bb9f8-ede5-459f-badc-e73981217fc2
h2 = replace(h, "\"" => "'")

# ╔═╡ f6ba3402-9150-4f5c-8533-47f8a9953e4c
@info(h2)

# ╔═╡ 576b38e2-6b77-4409-a647-7211c1ba6996
mermaid"""
flowchart TD
     A[$(h2)]
     A --> B[Regular Node]
...
# ╔═╡ d59cee6e-6411-4f91-80c0-f94b493012c4
h2 |> HTML

# ╔═╡ 69461bd7-940b-4db6-9dfc-c2e8476f3ab8
h |> HTML

# ╔═╡ 490b2a47-86ae-4c99-aef7-274c7b47346f
h
...
judgesquires = map(c -> string(c), collect('e':'i'))

# ╔═╡ 5dd9f353-1600-46ea-8054-e5c9db042be4
ruthquires = filter(map(c -> string(c), collect('i':'k'))) do s
	s != "j"
end
...
# ╔═╡ 6bdc34b5-ee29-4bdb-94b5-39ed5869a513
...
# ╔═╡ 5c796b32-1555-43b9-8f0e-5decfb43f5bd
"""Generate page IDs for a ternion with a given quire ID."""
function binion(id)
	ids = []
	for folio in 1:4
...
function dovol(folincipits)
	rangeinfo = []
	for i in folincipits[1:end-1]
		ref(folincipts[i])
	end
end
...
findfirst(s -> s == "a_1v",spanners)

# ╔═╡ e15d0d75-24e8-41a1-b547-b2bef54b05c6
md"""> ## Simpler"""

# ╔═╡ a7507211-5c96-43f8-b90b-eeaa5a0d6917
...
function volume2pages()
	...
	ternionpages = v2ternions  |> Iterators.flatten |> collect
	vcat(ternionpages, quaternion("vv") )
...
# ╔═╡ 7c2e2465-2c93-4176-97fd-22bf631dcae6
mermaid"""
graph TD

Bifolio1(( )) --> X[<img src="https://manuscriptroadtrip.wordpress.com/wp-content/uploads/2015/01/voynich-detail.jpg"/>]
Bifolio1 --> Bifolio2(( ))
Bifolio1 --> $(quire)6
...
# ╔═╡ 7a0e725d-2fb9-4193-815d-29f2aa34eee0
quirepages = filter(trip -> contains(trip.page,string(":v", volume, "_", quire, "_")), data)

# ╔═╡ ff6c569a-a519-4cf2-b005-dde3459c02af
quirepages
...
manifest_format = "2.0"
project_hash = "08a8abefd633232d1a9d17224c1a28d7adf53ff3"
