...
# ╔═╡ e8edefd6-eb9b-4155-a758-7d40b6154c14
...
# ╔═╡ dc48031f-3f52-409b-82a4-beb252678b70
lclex = filter(t -> t.passage.text[1] |> islowercase, lex)

# ╔═╡ bd39b96c-8b7e-4749-aeee-a524748c3b69
countsall = map(tkn -> lowercase(tkn.passage.text), lex) |> countmap |> OrderedDict

# ╔═╡ d91449b5-b2d0-4b2e-91e0-d5df3c3490b9
countsraw = map(tkn -> tkn.passage.tex), lclex) |> countmap |> OrderedDict
...
- Citable passages: **$(length(vulgate.passages))**
