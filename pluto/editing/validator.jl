...
# ╔═╡ 4907355b-51c5-4456-967d-e8d87d0364bc
nbversion = "1.0.0";

# ╔═╡ 733a5e8a-bf49-4ff1-9c91-0c5858d22df1
md"""*Notebook version*: **$(nbversion)** *See version info*: $(@bind versioninfo CheckBox())"""

# ╔═╡ c959dc42-2db7-42a3-a869-84d29f6b207a
if versioninfo
	md"""
- **1.0.0**: initial release of notebook using version 0.22.0 of `EditorsRepo` package to group passages for validation by text
"""	
end

# ╔═╡ 560e32f1-6504-4394-b113-d102a51309a6
# From PlutoUI
TableOfContents()
...
# ╔═╡ e071be3d-2fdf-413f-ad9e-8d259b7865b6
md"""> # Notebook mechanics you don't need to look at"""

# ╔═╡ 09c22eef-ad14-4d50-bead-335a6f4b997c
md"""> ## Image services"""

# ╔═╡ 788808d2-912b-4c60-9288-c5d5f79b2cc8
"""Base URL for an ImageCitationTool."""
function ict()
	"http://www.homermultitext.org/ict2/?"
end

# ╔═╡ 9f69b12d-4376-4b6d-bead-76f68fe2fe8f
...
# ╔═╡ fde9c6fe-231b-4261-a15b-149759ff9038
md"""> ## Structured repository"""

# ╔═╡ af449bba-3275-4def-b5b3-7a9c5227b55d
...
# ╔═╡ 6328dd60-fbb7-4698-adc1-a8d0760bbb65
...
# ╔═╡ 2e25ef6d-96ac-4223-92f3-fd96a0f188ed
surfaceurn = isempty(surface) ? nothing  : Cite2Urn(surface)

# ╔═╡ c5906193-d685-4f51-a0d8-22057d1b14c0
md"""> ## Display CSS"""

# ╔═╡ ff3c0cfc-3314-42ed-b2e4-208fadcad544
function waiting()
...
begin
	if isnothing(surfaceurn)
		...
		Markdown.parse(indexingcompleteness_md(r, surfaceurn, strict = false, width=thumbht))
	end
end

# ╔═╡ 43907362-d1ce-479c-a177-812d33a419f9
if isnothing(surfaceurn)
	HTML(waiting())
else
	mdsrc = indexingaccuracy_md(r, surfaceurn, strict = false, width=textheight)
	Markdown.parse(mdsrc)
end

# ╔═╡ fda4bc7f-2489-4437-b65a-e47e6e1b87f9
css = html"""
<style>
.waiting {
	color: silver;
...
manifest_format = "2.0"
project_hash = "dcd9a941ed2c967451029dcd03ac908555df8cd3"
...
git-tree-sha1 = "f22c97781352e6e35e0f6f8a994de9719320d567"
...
git-tree-sha1 = "d16704bddea32461b28400112f86b19fd2addcdc"
...
git-tree-sha1 = "ebc8deb72b222527a83b1d0cdbe2d49eb9564560"
