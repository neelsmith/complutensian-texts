...
The center column is in Latin; the exterior text is in Hebrew. The exterior will be on the right side for recto (odd numbered) pages, and on the left for verso (even numbered) pages. Ignore characters at the end of the Hebrew and Latin columns that serve only to help keep the two versions aligned.
